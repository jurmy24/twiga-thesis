...
class Metadata(BaseModel):
    ...
    def to_dict(self):
        return {
            ...
            "subsubsection": self.subsubsection if self.subsubsection is not None else None,
            "doc_type": self.doc_type,
            "exercise_format": self.exercise_format if self.exercise_format is not None else None
        }
...
class PipelineData(BaseModel):
    ...
    def to_dict(self):
        return {
            ...
            "retrieved": [retrieved_doc.to_dict() for retrieved_doc in self.retrieved_docs] if self.retrieved_docs is not None else None,
