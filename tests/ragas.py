...
def compute_ragas_results(dataset: Dataset, get_context_relevance:bool=True, only_answer_relevance: bool=False, verbose: bool=False) -> pd.DataFrame:
...
def run_for_pipeline_5_7(pipeline_data: List[PipelineData], get_context_relevance: bool) -> pd.DataFrame:
    data = {
...
if __name__ == "__main__":
    ...
    csv_file_ragas = os.path.join(DATA_DIR, "results", "baseline-1-ragas-analysis-control.csv")
